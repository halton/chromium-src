...
deps = {
  ...
  'src/third_party/minhook':
    'https://github.com/halton/minhook@b2e46f3c8224d5bcf684c724f600d61b15aae6cd',

  'src/third_party/sgxsdk':
    'https://github.com/1redcore/sgx-sdk.git@refs/remotes/origin/master',
  # === REDCORE Code End ===
