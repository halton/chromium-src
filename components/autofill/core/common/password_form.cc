...
#ifdef REDCORE
  target->SetString("YSPUserName_value", form.ysp_username_value);
  target->SetString("YSPAppName_value", form.ysp_app_name_value);
  target->SetString("YSPLoginType_value", form.ysp_login_type_value);
#endif
}
