...
function HistoryView(model) {
  ...
  // if ($('search-button').offsetWidth == 0) // use icon replace
...
function load() {
  ...
  $('search-icon').addEventListener('click', doSearch);
...
function yspShowClearButtons() {
  $('clear-browsing-data').hidden = false;
  $('remove-selected').hidden = false;
}

function yspHideClearButtons() {
  $('clear-browsing-data').hidden = true;
  $('remove-selected').hidden = true;
}
