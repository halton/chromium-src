...
cr.define('options', function() {
  ...
  StartupOverlay.prototype = {
    ...
    initializePage: function() {
      ...
      chrome.send('requestStartUpSetting');
    ...
    updateAutocompleteSuggestions_: function(suggestions) {
       ...
       * 2018 5.8 by Getong
       */
    getStartUpSettingCallback_: function(data){
      if (data) {
          var inputRadioList = document.getElementById('startup-section-content').getElementsByTagName('input');
          inputRadioList[0].setAttribute('disabled', 'disabled');
          inputRadioList[1].setAttribute('disabled', 'disabled');
          document.getElementById('startup-set-pages').style.display = 'none';
		  document.getElementById('change-home-page').style.display = 'none';
      }
    }
  };
