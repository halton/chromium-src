...
cr.define('options', function() {
  ...
  BrowserOptions.prototype = {
    ...
    initializePage: function() {
      ...
      // On personal data section
      // $('upload-avatar-trigger') && $('upload-avatar-trigger').onclick = function() {
      ...
      $('manage-ADpasswords').onclick = function (event) {
          PageManager.showPageByName('SWA');
          OptionsPage.showTab($('passwords-nav-tab'));
          chrome.send('coreOptionsUserMetricsAction',
              ['Options_ShowADPasswordManager']);
      };
      ...
      if (loadTimeData.getBoolean('cloudPrintShowMDnsOptions')) {
        $('cloudprint-options-mdns').hidden = true;
      ...
      //ysp+ { setting
      if (!loadTimeData.getBoolean('showSyncSection')) {
        $('sync-section').hidden = true;
      }
      // if (!loadTimeData.getBoolean('showStartupSection')) {
        // $('startup-section').hidden = true;
      // }
      $('sync-users-section').hidden = true;
      $('themes-gallery').hidden = true;
      $('themes-reset').hidden = true;
      //ysp+ }
    ...
    */
    ...
    yspShowClearButtons_: function() {
      $('privacyClearDataButton').hidden = false;
    },

    yspHideClearButtons_: function() {
      $('privacyClearDataButton').hidden = true;
    },
