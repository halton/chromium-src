...
var PasswordADManager = options.PasswordADManager;
...
var PersonalDataUpload = options.PersonalDataUpload;
var PersonalData = options.PersonalData;
var PersonalDevice = options.PersonalDevice;

//zeq change psw {
var ResetPasswordOverlay = options.ResetPasswordOverlay
// zeq change psw }
/**
...
function load() {
  ...
  // Make sure load before anothers. I dont know why.
  PersonalData.getInstance().initialize();
  PersonalDevice.getInstance().initialize();
...
// zeq regist chage psw pop window. {
  PageManager.registerOverlay(ResetPasswordOverlay.getInstance(),
                              BrowserOptions.getInstance(),
                              [$('rdc_reset_password')]);
// zeq regist chage psw pop window. }
  PageManager.registerOverlay(PasswordManager.getInstance(),
                              BrowserOptions.getInstance(),
                              [$('manage-passwords')]);
  PageManager.registerOverlay(PasswordADManager.getInstance(),
                              BrowserOptions.getInstance(),
                              [$('manage-ADpasswords')]);
  ...
  PageManager.registerOverlay(SyncSetupOverlay.getInstance(),
                              BrowserOptions.getInstance(),
                              [$('customize-sync')]);
  PageManager.registerOverlay(PersonalDataUpload.getInstance(),
                              BrowserOptions.getInstance(),
