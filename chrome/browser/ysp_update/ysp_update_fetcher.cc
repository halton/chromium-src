...
const char kUploadPath[] =
    "/client/v3/configuration/pc/";  //获取PC设置为自动升级
...
void YSPUpdateFetcher::StartCheck(const std::string& server_url,
  ...
  content::BrowserThread::PostDelayedTask(
      ...
      base::Bind(&YSPUpdateFetcher::DoStartCheck, base::Unretained(this)),
...
void YSPUpdateFetcher::OnJsonParseFailure(const std::string& error) {
...
void YSPUpdateFetcher::OnURLFetchComplete(const net::URLFetcher* source) {
  ...
  data_decoder::SafeJsonParser::Parse(
      ...
      json_data, base::Bind(&YSPUpdateFetcher::OnJsonParseSuccess, AsWeakPtr()),
