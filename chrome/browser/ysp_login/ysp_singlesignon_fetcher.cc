...
void YSPSingleSignOnFetcher::StartGetSingleSignOn(const std::string& server_url,
  ...
  // build form data
  net::AddMultipartValueForUpload("companyId", company_id, kMultipartBoundary,
                                  "", &post_data);
  net::AddMultipartValueForUpload("uuid", uuid, kMultipartBoundary, "",
                                  &post_data);
...
void YSPSingleSignOnFetcher::DoStartGetSingleSignOn(
...
void YSPSingleSignOnFetcher::OnJsonParseFailure(const std::string& error) {
