...
void YSPCompanyInfoFetcher::StartGetCompanyInfo(
...
void YSPCompanyInfoFetcher::DoStartGetCompanyInfo(const std::string& post_data) {
...
void YSPCompanyInfoFetcher::OnJsonParseFailure(
