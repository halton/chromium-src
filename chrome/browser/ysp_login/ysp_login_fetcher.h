...
private:
    ...
    std::string autoConfigFlags_old = ""; //ysp+ { auto get config }
    static std::string autoConfigFlags_now; //ysp+ { auto get config }
    int frequency = 0; //ysp+ { auto get config }
    static bool autoGetConfig_; //ysp+ { auto get config }
