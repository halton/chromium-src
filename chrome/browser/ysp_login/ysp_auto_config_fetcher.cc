...
void YSPAutoConfigFetcher::StartGetConfigVersion(
...
void YSPAutoConfigFetcher::OnJsonParseSuccess(
  ...
  YSPLoginManager::GetInstance()->OnAutoConfigParseSuccess(
      std::unique_ptr<base::DictionaryValue>(
          static_cast<base::DictionaryValue*>(parsed_json.release())),
      auto_fetch_);
}

void YSPAutoConfigFetcher::OnJsonParseFailure(const std::string& error) {
