...
public:
	...
	static RendererModeBubbleView* GetBubbleView() { return pRendererModeBubbleView; }
...
private:
	...
	RendererModeBubbleView(views::View* anchor_view,	Browser* browser, const GURL& url, RendererMode mode);
