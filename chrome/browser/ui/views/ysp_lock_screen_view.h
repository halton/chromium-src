...
// ViewState view_state_;
  ...
  views::View* CreateLoginSubview(views::View** focus_view,
                                  int* prefer_width);
  views::View* CreateLogoutSubview(views::View** focus_view,
                                   int* prefer_width);
  views::View* CreateSettingSubview(views::View** focus_view,
                                    int* prefer_width);
  views::View* CreateLoadingSubview(views::View** focus_view,
                                    int* prefer_width);
